...
namespace Skyline.DataMiner.Github.Repositories.Views.Explanations
{
	...
	public class DataMinerTokenView : ExplanationInputView
	{
		public DataMinerTokenView(IEngine engine) : base(engine, "DataMiner Token")
		{
			var explanation = new StringBuilder();
			explanation.AppendLine("A DataMiner Deploy key or token can be generated or found by going to admin.dataminer.services");
